...
Suite *s21_sub_matrix_suite(void) {
  ...
  TCase *o = tcase_create("sub_matrix");

  tcase_add_test(o, test_sub_matrix_1);
  tcase_add_test(o, test_sub_matrix_2);
  tcase_add_test(o, test_sub_matrix_3);
  tcase_add_test(o, test_sub_matrix_4);
  tcase_add_test(o, test_sub_matrix_5);
  tcase_add_test(o, test_sub_matrix_6);
  tcase_add_test(o, test_sub_matrix_7);
  tcase_add_test(o, test_sub_matrix_8);
  tcase_add_test(o, test_sub_matrix_9);
  tcase_add_test(o, test_sub_matrix_10);
  tcase_add_test(o, test_sub_matrix_11);
  tcase_add_test(o, test_sub_matrix_12);
  tcase_add_test(o, test_sub_matrix_13);
  tcase_add_test(o, test_sub_matrix_14);
  tcase_add_test(o, test_sub_matrix_15);
  tcase_add_test(o, test_sub_matrix_16);
  tcase_add_test(o, test_sub_matrix_17);
  tcase_add_test(o, test_sub_matrix_18);
